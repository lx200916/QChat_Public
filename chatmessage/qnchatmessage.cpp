...
//    te_font.setLetterSpacing(QFont::AbsoluteSpacing, 0);             //设置字间距为3像素 //设置字间距像素值
    ...
    m_leftPixmap = QPixmap(":/img/tou1.jpg");
    m_rightPixmap = QPixmap(":/img/tou2.jpg");
...
void QNChatMessage::setpicSuccess(QString mtou,QString tatou){
    m_leftPixmap = QPixmap(":"+tatou);
    m_rightPixmap=QPixmap(":"+mtou);
}
